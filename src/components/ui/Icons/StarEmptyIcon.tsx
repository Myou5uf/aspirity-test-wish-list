    ...
    return (
        ...
        >
            <path
                ...
                0 0 0 .393-.288L8 2.223l1.847 3.658a.525.525 0 0 0 .393.288l4.052.575-2.906 2.77a.565.565 0 0
                0-.163.506l.694 3.957-3.686-1.894a.503.503 0 0 0-.461 0z"
                fill="#f34068"
            />
        </svg>
    );
...
export default React.memo(StarEmptyIcon);
